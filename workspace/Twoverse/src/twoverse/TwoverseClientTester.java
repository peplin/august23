...
public class TwoverseClientTester {
    ...
    public static void main(String[] args) {
        ...
        RequestHandlerClient requestHandler =
                new RequestHandlerClient(objectManager);

        // User user = new User(0, "peplin", "123123123", "peplin@umich.edu",
        // "3135804520", 42);

        Galaxy galaxy =
                new Galaxy(-1, 1, "MyGalaxy", null, null, -1, new Point(42, 43,
