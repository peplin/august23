...
INSERT INTO `user` (`id`, `username`, `password`, `email`)
    VALUES (1, 'peplin', '$2a$10$NFxXDzT.Ep2Hz8vQEdtyH.VBDSIPeuM/sUG3bYJGoE3MtNv3uJXu2', 'peplin@umich.edu');
INSERT INTO `user` (`id`, `username`, `password`, `email`)
    VALUES (2, 'august_mt', '$2a$10$NFxXDzT.Ep2Hz8vQEdtyH.VBDSIPeuM/sUG3bYJGoE3MtNv3uJXu2', 'august23@umich.edu');
INSERT INTO `user` (`id`, `username`, `password`, `email`)
    VALUES (3, 'august_web', '$2a$10$NFxXDzT.Ep2Hz8vQEdtyH.VBDSIPeuM/sUG3bYJGoE3MtNv3uJXu2', 'august23@umich.edu');
INSERT INTO `user` (`id`, `username`, `password`, `email`)
    VALUES (4, 'august_client', '$2a$10$NFxXDzT.Ep2Hz8vQEdtyH.VBDSIPeuM/sUG3bYJGoE3MtNv3uJXu2', 'august23@umich.edu');
