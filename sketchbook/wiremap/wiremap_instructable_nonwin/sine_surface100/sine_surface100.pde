...
float map_length        = 31.25;               // The mapline is 1.28 meters wide
float depth_unit        = 0.3125;               // Each depth unit is 5 millimeters
float map_unit          = 0.3125;               // Each mapline unit is 5 millimeters
int wire                = 100;                // There are 128 wires in this Wiremap
...
static public void main(String args[]) {
  PApplet.main(new String[] { "--present", "sine_surface100" });
}
