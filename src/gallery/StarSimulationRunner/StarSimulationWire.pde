...
(stellar evolution) for the Wiremap.

It takes input of a color and a frequency - these determine the oscillation rate
of the star and its end of life scenario.
...
to determine some property of its creation.

Input: 
observer's Color: RED more massive; Blue less massive; eol depends on mass.
...
public class StarSimulationWire {
    ...
    private float grow(float rini, float rfin, float rate , float t1,
            float t2) {
