...
/**
 * The Wiremap Client is not a direct Twoverse client. It requires a connection
 * to a running instance of a MultitouchClient. This client is inteded for use
 * in the August 23, 1966 gallery installation. <br>
 * <br>
 * 
 * This client waits for a signal from the Multitouch Client that a new star
 * should be created. The star formation sequence then begins as follows:<br>
 * Ambient spaceship sounds are played through the local sound card. <br>
 * <br>
 * 
 * A voice over is played requesting the user to enter the airlock and plate
 * their finger on the heartbeat detector to connec their lifeline.<br>
 * <br>
 * 
 ...
 * sent to the Multitouch Client and saved into the star simulation.<br>
 * <br>
 * 
 ...
 * Client computer - this is for pumping out over the radio headset.<br>
 * <br>
 * 
 ...
 * multitouch client so that the animations match.<br>
 * <br>
 * 
